...
def main():
    ...
    directory_in_str = "../large_dataset/whale_files/selected_train"

    df = pd.read_csv("../large_dataset/whale_files/train.csv",header=None,names = ["Image", "Id", "Xmin", "Ymin", "Xmax", "Ymax"])
    df = df.drop([0])
    train_selected = pd.DataFrame(columns=["Image", "Id", "Xmin", "Ymin", "Xmax", "Ymax"])
    ...
    for file in tqdm(os.listdir(directory)):
        ...
        if filename.endswith(".jpg"):
            ...
            continue
    df.to_csv('train_box.csv', encoding='utf-8', index=False)
    manual_check.to_csv('manual_check.csv', encoding='utf-8', index=False)
