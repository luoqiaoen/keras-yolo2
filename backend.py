...
FULL_YOLO_BACKEND_PATH  = "../large_backends/full_yolo_backend.h5"   # should be hosted on a server
TINY_YOLO_BACKEND_PATH  = "../large_backends/tiny_yolo_backend.h5"   # should be hosted on a server
SQUEEZENET_BACKEND_PATH = "../large_backends/squeezenet_backend.h5"  # should be hosted on a server
MOBILENET_BACKEND_PATH  = "../large_backends/mobilenet_backend.h5"   # should be hosted on a server
INCEPTION3_BACKEND_PATH = "../large_backends/inception_backend.h5"   # should be hosted on a server
VGG16_BACKEND_PATH      = "../large_backends/vgg16_backend.h5"       # should be hosted on a server
RESNET50_BACKEND_PATH   = "../large_backends/resnet50_backend.h5"    # should be hosted on a server
